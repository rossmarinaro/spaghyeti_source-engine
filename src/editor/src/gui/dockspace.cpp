...
void GUI::RenderDockSpace()
{
    ...
    ImGui::Begin("Toolbar");
        ...
        if (ImGui::BeginMenu(("Project: " + Editor::events.currentProject).c_str()))
        {
            ShowMenu();
            ImGui::EndMenu();
        }
    ...
    ImGui::Begin("Workspace", p_open, window_flags);
        ...
        if (io.ConfigFlags & ImGuiConfigFlags_DockingEnable)
        {
            ...
            if (first_time)
            {
                ...
                auto dock_id_up_ws = ImGui::DockBuilderSplitNode(dockspace_id_ws, ImGuiDir_Up, 0.14f, nullptr, &dockspace_id_ws);
    ...
    ImGui::Begin("Session", p_open, window_flags);
        ...
        if (io.ConfigFlags & ImGuiConfigFlags_DockingEnable)
        {
            ...
            if (first_time)
            {
                ...
                auto dock_id_up_ws = ImGui::DockBuilderSplitNode(dockspace_id_ws, ImGuiDir_Up, 0.46f, nullptr, &dockspace_id_ws);
                auto dock_id_down_ws = ImGui::DockBuilderSplitNode(dockspace_id_ws, ImGuiDir_Down, 1.6f, nullptr, &dockspace_id_ws);
