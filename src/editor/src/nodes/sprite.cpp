                            ...
                            for (int i = 0; i < animations.size(); i++)
                            {
                                ...
                                if (spriteHandle && spriteHandle->IsSpritesheet()) 
                                {
                                    if (ImGui::Button("play")) {
                                        m_currentAnim.key = animations[i].key;
                                        m_currentAnim.start = animations[i].start;
                                        m_currentAnim.end = animations[i].end; 
                                        m_currentAnim.rate = animations[i].rate;
                                        m_currentAnim.repeat = animations[i].repeat;
                                        m_currentAnim.yoyo = animations[i].yoyo;
                                    }
