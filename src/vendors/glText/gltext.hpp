...
GLT_API void gltOutlineColor(GLfloat r, GLfloat g, GLfloat b, GLfloat a);
...
static GLint _gltText2DShaderOutlineColorUniformLocation = -1;
...
GLT_API void gltOutlineColor(GLfloat r, GLfloat g, GLfloat b, GLfloat a)
{
	glUniform4f(_gltText2DShaderOutlineColorUniformLocation, r, g, b, a);
}
...
static constexpr GLchar* _gltText2DFragmentShaderSource =
	...
	"void main()\n"
	"{\n"
    " vec4 c = texture(diffuse, fTexCoord) * color;\n"
    "   if (c.r == 0.0 && c.g == 0.0 && c.b == 0.0)\n"
    "	    fragColor = mix(c, outlineColor, c.a);\n"
	"	else fragColor = c;\n"
	"}\n";
...
GLT_API GLboolean _gltCreateText2DShader(void)
{
    ...
    _gltText2DShaderOutlineColorUniformLocation = glGetUniformLocation(_gltText2DShader, "outlineColor");
